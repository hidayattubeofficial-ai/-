...
async def generate_voice(text: str, output_path: str, voice: str = VOICE) -> None:
    ...
    print(f"✅ Edge-TTS voice saved: {output} (voice={voice}, rate={RATE})")
...
if __name__ == "__main__":
    sample = "السلام علیکم ورحمۃ اللہ وبرکاتہ۔ آج کی اسلامی یاددہانی پیش خدمت ہے۔"
    synthesize(sample, "output/voice-test.mp3")
